                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-grow space-y-4">
                      ...
                      <div className="space-y-4">
                        <div>
                          <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Desktop Instructions</label>
                          <textarea
                            required
                            rows={4}
                        ...
                        <div>
                          <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Mobile Instructions</label>
                          <textarea
                            required
                            rows={4}
