          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center bg-gray-100 p-1 rounded-lg self-start">
                <button
                  type="button"
                  onClick={() => setEditPlatform('desktop')}
                  className={cn(
                    "flex items-center px-4 py-1.5 rounded-md text-[10px] font-bold uppercase tracking-wider transition-all",
                    editPlatform === 'desktop' ? "bg-white text-emerald-600 shadow-sm" : "text-gray-500 hover:text-gray-700"
                  )}
                >
                ...
                <button
                  type="button"
                  onClick={() => setEditPlatform('mobile')}
                  className={cn(
                    "flex items-center px-4 py-1.5 rounded-md text-[10px] font-bold uppercase tracking-wider transition-all",
                    editPlatform === 'mobile' ? "bg-white text-emerald-600 shadow-sm" : "text-gray-500 hover:text-gray-700"
                  )}
                >
