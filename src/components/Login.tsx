  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <button
          onClick={login}
          className="w-full flex items-center justify-center px-6 py-4 bg-white border-2 border-gray-100 text-gray-700 font-bold rounded-2xl hover:bg-gray-50 hover:border-emerald-200 transition-all group"
        >
          <img 
          ...
          />
          Sign in with Google
          <LogIn className="w-5 h-5 ml-3 text-gray-300 group-hover:text-emerald-600 transition-colors" />
        </button>
